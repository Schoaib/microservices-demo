...
Configuration in this directory creates an AWS EKS cluster with Self Managed Node Groups (AutoScaling Groups) demonstrating the various methods of configuring/customizing:
